...
export default function NetworkPort() {
  ...
  async function handleSave() {
    const { entityId, serialNumber, manufactur, port, year } = formData;
    if (!entityId || !serialNumber || !manufactur || !port || !year) {
  ...
  return (
    <>
      ...
      <ConfirmDeleteModal
        ...
        itemLabel={deleteTarget ? `${deleteTarget.entityId} (SN: ${deleteTarget.serialNumber})?` : ""}
